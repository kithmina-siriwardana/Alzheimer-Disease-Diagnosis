...
export default function EmotionRecognitionPage() {
  ...
  return (
    <AppLayout>
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-800">Emotion Recognition</h1>
        <p className="text-gray-600">Detect emotions from facial expressions or speech patterns to assist in patient care</p>
      </div>
